...
class SpaceSaving():
    ...
    def swap(self, isWeight, tuple_x, tuple_y):
        ...
        if isWeight:
            assert self.weight_heap[x_weight_index][0] == x, 'idk'
            assert self.weight_heap[y_weight_index][0] == y, 'idk'
        else:
            assert self.error_heap[x_error_index][0] == x, 'idk'
            assert self.error_heap[y_error_index][0] == y, 'idk'
    ...
    def output(self):
        ...
        print("error_heap: ", self.error_heap)
